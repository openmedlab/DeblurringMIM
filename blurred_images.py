...
def get_args_parser():
    ...
    parser.add_argument('--src_dir', default="/qingbo/ddpm/ddpm-segmentation/mae/data/hx_t1/train/b/", type=str,
                        help='source directory for images needed to be blurred.')
    parser.add_argument('--dst_dir', default="/qingbo/ddpm/ddpm-segmentation/mae/data/hx_t1_blurred/train/b/", type=str,
...
def main(args):
    ...
    for file_name in os.listdir(args.src_dir):
        img = cv2.imread(args.src_dir + file_name, cv2.IMREAD_GRAYSCALE)
        ...
        cv2.imwrite(args.dst_dir + file_name, img_blured)
