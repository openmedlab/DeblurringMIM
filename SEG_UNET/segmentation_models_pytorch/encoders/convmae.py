...
from .convmae_ckpt import load_checkpoint
...
class ConvMAE(nn.Module):
    ...
    """
    def __init__(self, img_size=[512, 128, 64], patch_size=[4,2,2], in_chans=3, num_classes=2, embed_dim=[256,384,768], depth=[2,2,11],
                 num_heads=12, mlp_ratio=[4,4,4], out_channels=(3, 256, 384, 768, 768),
                 qkv_bias=True, qk_scale=None, drop_rate=0., attn_drop_rate=0.,
                 drop_path_rate=0.2, hybrid_backbone=None, norm_layer=nn.LayerNorm,
                 init_values=1, use_checkpoint=False,
                 use_abs_pos_emb=True, use_rel_pos_bias=True, use_shared_rel_pos_bias=False,
                 out_indices=[3, 5, 7, 11], fpn1_norm='SyncBN', pretrained=None):
        super().__init__()
        ...
        self.fpn = nn.Sequential(
            nn.Conv2d(embed_dim[-1], embed_dim[-1], kernel_size=3, stride=2, padding=1),
    ...
    def init_weights(self, pretrained=None):
        ...
        if isinstance(pretrained, str):
            ...
            print ("****************load checkpoint:", pretrained)
...
# pretrained_settings = {
#     "imagenet": "/qingbo/ConvMAE-main/imagenet_weights/convmae_base.pth",
#     "us10k": "/qingbo/ConvMAE-main/pretrain_convmae/0401_base_ushx_val/checkpoint-1600.pth",
#     "us280k": '/qingbo/ConvMAE-main/pretrain_zk/0425_convmae_base/checkpoint-799.pth',
#     "us10k_deblur": '/qingbo/ConvMAE-main/pretrain_convmae/0401_base_ushx_val_gaussian/checkpoint-1600.pth',
#     "us280k_deblur": '/qingbo/ConvMAE-main/pretrain_zk/0425_dconvmae_base_gaussian/checkpoint-799.pth',
# }
...
convmae = {
    "convmae": {
       ...
       # "pretrained_settings": pretrained_settings,
        "params": {
            #"pretrained": '/qingbo/ConvMAE-main/imagenet_weights/convmae_base.pth',
        },
    }
}