...
def get_args_parser():
    ...
    # convit_base
    parser.add_argument('--model', default='convit_base', type=str, metavar='MODEL',
    ...
    parser.add_argument('--early_stops', default=400, type=int,
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/qingbo/ddpm/ddpm-segmentation/mae/data/us_hx_easy_split/', type=str,
                        help='dataset path')
    parser.add_argument('--nb_classes', default=2, type=int,
                        help='number of the classification types')

    parser.add_argument('--output_dir', default='/qingbo/ConvMAE-main/dir_ft/0330_sp_base/',
                        help='path where to save, empty for no saving')
    # parser.add_argument('--log_dir', default='/qingbo/ConvMAE-main/dir_ft/0330_imagenet_base/',
...
#        interpolate_pos_embed(model, checkpoint_model)
    ...
    if args.eval:
        ...
        acc, f1 = evaluate_test(dataset_test, model, device)
        print ("Acc:", acc*100)
        print ("F1:", f1*100)
        exit(0)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        #         args=args, model=model, model_without_ddp=model_without_ddp, optimizer=optimizer,
        #         loss_scaler=loss_scaler, epoch=epoch)
        print(f'Max F1: {max_accuracy:.2f}%\tat epoch:', max_epoch)
